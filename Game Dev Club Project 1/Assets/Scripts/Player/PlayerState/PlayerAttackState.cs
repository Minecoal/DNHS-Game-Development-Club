...
public class PlayerAttackState : IPlayerState
{
    ...
    private void StartAttack(int index)
    {
        ...
        if (!data.useAnimationEvent)
        {
            ...
            attackList[index].ExecuteAttack(attackAnchor, ctx.transform, PlayerManager.Instance.MoveInput);
        }
    }

    public void OnAnimationAttack(int attackIndex)
    {
        attackList[attackIndex].ExecuteAttack(attackAnchor, ctx.transform, PlayerManager.Instance.MoveInput);
    }
